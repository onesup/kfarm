class Admin::JobsController < ApplicationController
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:category, :title, :contents, :started_at, :finished_at, :working_time, :start_time, :finish_time, :learning_time, :level, :workers_count, :pay, :location, :address, :mentor_id, :latitude, :longitude)
    end
end
